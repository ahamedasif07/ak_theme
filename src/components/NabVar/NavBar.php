 ...
 <nav id="main-navbar" class="bg-gray-200 shadow-md">
     ...
     <div id="mobile-menu" class="md:hidden hidden px-4 pb-4">
         <ul class="flex flex-col gap-2">
             ...
             <li><a href="<?php echo home_url('/about'); ?>" class="block px-4 py-2 hover:bg-gray-300 rounded">About</a>
             </li>

             <li><a href="<?php echo home_url('/service'); ?>"
                     class="block px-4 py-2 hover:bg-gray-300 rounded">Service</a></li>
